...
const Home = () => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
    >
      <div className="flex flex-col items-center w-[1000px] mx-auto px-4 p-6">
        <h1 className="text-4xl font-bold text-center mb-8">
          Product Showcase
        </h1>
        <div className="gap-3 flex flex-col md:flex-row items-center justify-between mb-6 space-y-4 md:space-y-0">
